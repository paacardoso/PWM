...
function showRemoveDialog(param) {
    if (typeof param != 'undefined')
        MessageBox.Ask('Remover Parâmetro', "Confirma a remoção do parâmetro '" + param.Name + "' ?", removeCancelled, function () { removeConfirmed(param); });
    else
        MessageBox.Ask('Remover Parâmetro', "Confirma a remoção dos parâmetros seleccionados ?", removeCancelled, function () { removeConfirmed(undefined); });
}
